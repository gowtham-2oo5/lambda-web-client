...
export async function GET(
  ...
  try {
    ...
    console.log(
      "🔍 HISTORY ITEM API - Response headers:",
    ...
    const historyItem = {
      ...
      repositoryName:
        data.repoName || data.repositoryName || data.repository_name,
      githubUrl: data.repoUrl || data.githubUrl || data.github_url || data.url,
      repositoryOwner:
        data.owner || data.repositoryOwner || data.repository_owner,
      generatedAt:
        data.createdAt ||
        data.generatedAt ||
        data.generated_at ||
      ...
      primaryLanguage:
        data.primaryLanguage || data.primary_language || data.language,
      frameworks: data.frameworks || data.framework || [],
      confidence: data.confidence || 0,
      processingTime: data.processingTime || data.processing_time || 0,
      readmeUrl:
        data.readmeS3Url || data.readmeUrl || data.readme_url || data.s3_url,
